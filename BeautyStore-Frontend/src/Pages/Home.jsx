    ...
    return (
      ...
      `}</style>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {categorias.map((cat) => (
                        <Link
                            to="/catalogo"
                            key={cat.idCategoria}
                            className="cat-card relative overflow-hidden block no-underline group"
                            style={{ height: '280px' }}
                        >
                            {/* Imagen: si tiene imagen en BD la usa, si no muestra fondo de color */}
                            {cat.imagen ? (
                                <img
                                    src={`/img/${cat.imagen}`}
                                    alt={cat.nombre}
                                ...
                                <div className="w-full h-full bg-[#F2E8E4] flex items-center justify-center">
                                    <span className="text-5xl text-[#C4975A]">✦</span>
                                </div>
                            )}
                            ...
                            <div className="absolute bottom-4 left-4 text-white">
                                ...
                                {cat.descripcion && (
                                    <div className="text-xs font-light opacity-80 mt-1" style={sans}>{cat.descripcion}</div>
                                )}
            ...
            <section className="px-8 lg:px-16 py-16 bg-[#F7F2EF]">
                ...
                {cargando ? (
                    <div className="text-center py-12 text-[#6B4E4E] font-light">Cargando destacados...</div>
                ) : (
